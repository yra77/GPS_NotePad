...
namespace GPS_NotePad.ViewModels
{
    class MapViewModel : BindableBase, INavigatedAware, IActiveAware
    {
        ...
        private void MarkerClicked(Position pos, string ImagePath, string Label, string Address)
        {
            ...
            MarkerInfo marker = new MarkerInfo { Address = Address, Label = Label, ImagePath = ImagePath, 
            ...
            _navigationService.NavigateAsync("ModalPageView", navParameters, useModalNavigation: true, animated: true);
        }
